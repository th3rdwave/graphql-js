...
function completeValue(
  ...
  // If result value is null or undefined then return null if stripNulls is false
  // or undefined if stripNulls is true.
  if (result == null) {
    return exeContext.stripNulls ? undefined : null;
  }
